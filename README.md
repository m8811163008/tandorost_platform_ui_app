...
* **احراز هویت:** مربی ابتدا ویدئو خود را به هوش مصنوعی برای احراز هویت میفرستد و بعد از تایید در صفحه لیست مربیان نمایش داده میشود و در صفحه جزئیات مربی، بازدیدکنندگان میتواننند به آن با یک بج شناسایی دسترسی داشته باشند

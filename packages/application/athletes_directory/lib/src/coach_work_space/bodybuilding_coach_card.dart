...
import 'package:athletes_directory/src/coach_work_space/bodybuilding_coach_program.dart';
import 'package:athletes_directory/src/coach_work_space/edit_dialog.dart';
import 'package:athletes_directory/src/coach_work_space/edit_user_info_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AppCard(
      child: Column(
        ...
        children: [
          AppCardHeader(title: context.l10n.coachSettingLabel),
        ...
        child: SizedBox.fromSize(
          ...
          child: ImageEditor(
            ...
            onComplete: (editedBytes) async {
              ...
              if (context.mounted) {
                context.read<AthelteDirectoryCubit>().onEditImageComplete(
                  editedBytes,

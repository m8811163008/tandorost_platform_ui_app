...
Map<String, dynamic> _$FitnessDataToJson(
  FitnessData instance,
) => <String, dynamic>{
  ...
  'waist_circumference_to_height_ratio':
      ?instance.waistCircumferenceToHeightRatio,
  'is_waist_circumference_to_height_ratio_safe':
      ?instance.isWaistCircumferenceToHeightRatioSafe,
  'is_waist_circumference_safe_range': ?instance.isWaistCircumferenceSafeRange,
};
